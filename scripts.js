...
async function cargarProducto() {
  ...
  try {
    ...
    const descripcionConSaltos = producto.descripcion.replace(/\n\n/g, '<br><br>');

    // Renderizar imagen con clases para tamaño uniforme
    document.getElementById('producto-imagen-container').innerHTML = `
      <img src="${producto.imagen}" alt="${producto.nombre}" class="producto-imagen-uniforme"/>
    `;
